package com.java.mbkh.common.sms;
...
public class AliSmsService {
    ...
    public int sendVerifyCode(String phoneNumbers, String code) {
        HashMap<String, String> templateParam = new HashMap<>();
        templateParam.put("code", code);
        return this.sendSms(phoneNumbers, templateCode, templateParam);
    }

    public int sendSms(String phoneNumbers, String templateCode, Map<String, String> templateParam) {
        return this.sendSms(phoneNumbers, templateCode, signName, templateParam);
    }

    public int sendSms(String phoneNumbers, String templateCode, String signName, Map<String, String> templateParam) {
    ...
    private int sendSms(final SendSmsRequest request) {
        int res = -1;
        try {
